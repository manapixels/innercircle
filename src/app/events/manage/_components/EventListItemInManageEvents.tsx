...
export default function EventListItemInMyEvents({
  ...
  return (
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between mb-3">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
              ...
              {(event.status !== 'completed' || !eventOver) && (
                <select
                  className="hidden md:block bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-base-500 focus:border-base-500 w-full p-2.5 dark:bg-gray-7000 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-base-500 dark:focus:border-base-500"
                  value={status}
    ...
    {(event.status !== 'completed' || !eventOver) && (
              <select
                className="block md:hidden py-4 bg-white border border-base-700 text-gray-900 text-sm rounded-lg focus:ring-base-500 focus:border-base-500 w-full p-2.5 dark:bg-gray-7000 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-base-500 dark:focus:border-base-500"
                value={status}
                onChange={(e) => setStatus(e.target.value)}
              >
                <option value="draft">Draft</option>
