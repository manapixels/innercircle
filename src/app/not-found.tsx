  ...
  return (
    <div>
      <div className="xl:pt-24 w-full max-w-lg xl:w-1/2 relative pb-12 lg:pb-0 mx-auto">
        ...
        >
          Go back home <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" style={{ display: 'inline-block' }}><path fill="currentColor" d="M4 21V9l8-6l8 6v12h-6v-7h-4v7z"></path></svg>
        </Link>
      </div>
    </div>
  );
