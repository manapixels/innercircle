...
type Enum_public_app_permission = 'events.create' | 'events.delete';
type Enum_public_app_role = 'admin' | 'participant';
type Enum_public_event_status = 'cancelled' | 'completed' | 'confirmed' | 'draft' | 'in progress';
...
interface Table_public_events {
  id: string;
  status: Enum_public_event_status;
  user_id: string;
  date_start: string;
  date_end: string;
...
interface Table_public_role_permissions {
  id: number;
  role: Enum_public_app_role;
  permission: Enum_public_app_permission;
}
...
interface Table_public_user_roles {
  id: number;
  user_id: string;
  role: Enum_public_app_role;
}
...
interface Schema_public {
  ...
  role_permissions: Table_public_role_permissions;
  user_roles: Table_public_user_roles;
...
interface Extension {
  extensions: "pg_stat_statements" | "uuid-ossp" | "pgcrypto" | "pgjwt";
  graphql: "pg_graphql";
  pgsodium: "pgsodium";
...
interface Tables_relationships {
  ...
  "public.events": {
    parent: {
       events_user_id_fkey: "public.users";
    };
    children: {
  ...
  "public.user_roles": {
    parent: {
       user_roles_user_id_fkey: "public.users";
    };
    children: {
  ...
  "public.users": {
    ...
    children: {
       events_user_id_fkey: "public.events";
       user_roles_user_id_fkey: "public.user_roles";
    };
  };
}
//#endregion
